"""Threat Crystal Protocol — shared spine primitive."""
...
# Risk-tier default horizons (ms) — overridden by control_policy_registry
...
def seal_crystal(
    *,
    ...
    """Create a Threat Crystal — immutable context snapshot before irreversible action."""
    crystal_id = f"tcrys_{uuid.uuid4().hex}"
...
def should_strand_on_expiry(risk_tier: str) -> bool:
    """TCP rule: critical and high never guess on horizon expiry."""
