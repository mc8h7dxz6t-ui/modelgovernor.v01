"""Spine adapter — platforms call Cybersecurity Governor spine or fall back to local mode."""
...
class SpineAdapter:
    def __init__(
        ...
        *,
        ...
        self.base_url = (base_url or os.environ.get("CG_SIDECAR_URL", "http://localhost:8101")).rstrip("/")
        enabled = spine_enabled if spine_enabled is not None else os.environ.get("CG_SPINE_ENABLED", "false").lower() == "true"
