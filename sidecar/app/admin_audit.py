...
from .ledger_seal import GENESIS_HASH, compute_row_hash
...
def record_admin_action(
    ...
    *,
    ...
    logger.info(
        "admin audit action=%s resource=%s actor=%s method=%s",
        action,
        resource,
        ctx.subject,
        ctx.method,
...
def _seal_admin_audit_row(
    ...
    *,
    ...
    row_hash = compute_row_hash(
        ...
        event_type=action,
        amount_delta=actor_method,
        metadata={"actor_roles": actor_roles, **details},
