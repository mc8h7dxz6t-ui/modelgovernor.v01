"""Spine adapter — platforms use Cybersecurity Governor spine or local fallback."""
...
class LocalPlatformEventLog:
    ...
    def __init__(self, db_path: str | None = None) -> None:
        path = db_path or os.environ.get("CG_PLATFORM_EVENTS_DB", ":memory:")
        self._path = path
...
class SpineAdapter:
    def __init__(
        ...
        *,
        ...
        self.base_url = (base_url or os.environ.get("CG_SIDECAR_URL", "http://localhost:8121")).rstrip("/")
        ...
        self._token = internal_token or os.environ.get("CG_INTERNAL_TOKEN", "dev-cg-spine-token-change-me")
    ...
    def crystallize(
        ...
        *,
        ...
        reserved_budget: str = "0",
        parent_crystal_id: str | None = None,
    ) -> Crystal:
        if self.spine_enabled:
            return self._http_crystallize(
                operation_id, risk_tier, facets, account_id, policy_id, reserved_budget, parent_crystal_id
            )
        ...
        with httpx.Client(timeout=30.0) as client:
            r = client.post(
                ...
                json={
                    ...
                    "committed_budget": outcome.committed_budget,
