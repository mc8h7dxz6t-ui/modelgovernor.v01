...
| ig-sidecar | 8101 | CCP crystallize/commit, claim escrow, security_ops |
...
- `GET /internal/security/verify-chain` — tamper detection (422 on break)
...
- `security_ops` session-wide invariant probes after sweep
