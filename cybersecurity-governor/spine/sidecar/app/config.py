...
class Settings(BaseSettings):
    ...
    fallback_max_action_depth: int = 50
    ...
    oidc_viewer_roles: str = "viewer,cybersecuritygovernor-viewer"
    oidc_claims_admin_roles: str = "security-admin,cybersecuritygovernor-security-admin"
