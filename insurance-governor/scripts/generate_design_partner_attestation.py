...
DATA_ROOM = ROOT / "docs" / "insurance-governor" / "data-room"
...
{partner} completed a **30-day design-partner rehearsal** of Insurance Governor on a **{env}** cluster. The attestation exercise validated governed claim commits, hash-chain integrity, ClaimGate FNOL ingest (US + UK PAS), and Postgres-backed payment idempotency under load.
