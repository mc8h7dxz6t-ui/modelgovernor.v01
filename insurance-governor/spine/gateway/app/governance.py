...
def execute_governed_commit(
    ...
    *,
    ...
    facets: dict[str, Any],
    policy_id: str | None,
    reserved_reserve: Decimal,
    committed_reserve: Decimal,
    outcome: str,
) -> dict[str, Any]:
    op_id = operation_id or f"gw-{uuid.uuid4().hex[:16]}"
    headers = {"x-internal-token": settings.ig_internal_token, "content-type": "application/json"}
    base = settings.ig_sidecar_url.rstrip("/")
    ...
    with httpx.Client(timeout=30.0) as client:
        crystallize = client.post(
            ...
            json={
                ...
                "facets": facets,
                "policy_id": policy_id,
                "reserved_reserve": str(reserved_reserve),
            },
        )
        ...
        commit = client.post(
            ...
            json={
                ...
                "facets": facets,
                "committed_reserve": str(committed_reserve),
                "outcome": outcome,
            },
        )
