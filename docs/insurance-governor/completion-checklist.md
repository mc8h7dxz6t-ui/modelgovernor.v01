# Insurance Governor — 100% completion checklist
...
| **ClaimGate** | FNOL US (Guidewire, Snapsheet, Majesco) | Done |
| **ClaimGate** | FNOL UK (Acturis, SSP, ICE InsureTech) | Done |
| **ClaimGate** | FNOL write-back (Guidewire, Acturis, ICE) | Done |
