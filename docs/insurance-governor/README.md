...
| [capability-matrix.md](capability-matrix.md) | RFP / diligence capability table |
| [operations-runbook.md](operations-runbook.md) | Incident response and routine ops |
...
| [insurance-governor-tomorrow-sale.md](../sales-sheets/insurance-governor-tomorrow-sale.md) | **Asset sale spec** — per-platform vs competitor, technical proof bundle |
